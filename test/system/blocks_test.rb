...
class BlocksTest < ApplicationSystemTestCase
  ...
  test "should create block" do
    ...
    fill_in "Apartments per floor", with: @block.apartments_per_floor
    fill_in "Floors count", with: @block.floors_count
    fill_in "Identification", with: @block.identification
